...
In Figure \ref{fig:sequenzSQLALCHEMY} ist eine sequentielle Darstellung des Prozesses zu sehen. 
...
\pythonexternal[%
    caption={Modulinitialisierung des Submoduls der Modell-Klassen},%
