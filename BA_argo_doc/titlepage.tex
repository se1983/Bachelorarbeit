...
\begin{titlepage}
    \begin{addmargin}[4cm]{-1cm}
        ...
        {\Huge
        \rmfamily{Konzeption und prototypische Entwicklung einer webbasierten Anwendung  zur Aggregation und Analyse wissenschaftlicher Daten aus dem Argo-Projekt}\par}
